<template>
  <div id="fondo">
    <div class="d-flex justify-content-center pt-5" id="overlay-oscuro">
      <div id="login-panel" class="px-4">
        <h3 class="text-center pt-5 pb-4">Ingresar al sistema</h3>
        <form>
          <div class="form-group">
            <label for="correo">Correo electrónico</label>
            <input type="email" class="form-control" name="correo" id="correo" placeholder="Ingrese su correo electrónico" v-model="correo">
          </div>
          <div class="form-group">
            <label for="contra">Contraseña</label>
            <input type="password" class="form-control" name="contra" id="contra" placeholder="Ingrese su contraseña" v-model="contra">
          </div>
          <div id="form-group">
            <input type="button" value="Ingresar" class="btn btn-lg btn-block btn-primary" v-on:click="loguearUsuario()">
          </div>
        </form>
      </div>
    </div>
